...
public:
    ...
    : m_pt1(new Minibus()), m_pt2(new Taxi()), m_m(other.m_m), m_t(other.m_t)
    {
...
void PublicConvoyCtorVoid(struct PublicConvoy *this)
{
    struct PublicTransport *new_mb = AS_PT calloc(1, sizeof(struct Minibus));
    struct PublicTransport *new_tx = AS_PT calloc(1, sizeof(struct Taxi));

    this->m_pt1 = new_mb;
    this->m_pt1 = new_tx;
    this->m_pt.vtptr = (struct PTvTable *)&pcvt;
} */
